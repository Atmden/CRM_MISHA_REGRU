    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="input-file">
                ...
                <md-button :disabled="images.length < 1" class="btn btn-blue" @click="upload">Загрузить фото</md-button>
            </div>
        </div>
        <div class="col-lg-6">
            <h3>Видео</h3>
...
<style>
    ...
    .input-file li > div > label, .select-image > label {
        width: 100%;
        height: 100%;
        display: block;
        margin: 0;
    ...
    .input-file li > div > label > i, .select-image > label > i {
        top: 50%;
    ...
    .input-file input, .select-image input {
        display: none;
    }
    ...
    export default {
        ...
        methods: {
            handleSort(e) {
                ...
                this.$emit('sortImage',{ images: this.uploaded_images});
            ...
            handleVSort(e) {
                ...
                this.$emit('sortVideo',{ videos: this.uploaded_videos});
                //this.$parent.upload_images_main = this.uploaded_images;
            ...
            deleteImageFromServer(index) {
                this.loading = true;
                axios.get('/api/upload_images/delete/' + index)
                    .then(response => {
            ...
            deleteVideoFromServer(index) {
                ...
                axios.get('/api/upload_videos/delete/' + index)
                    .then(response => {
            ...
            upload() {
                ...
                formData.append('random_number', this.random_number);
                ...
                axios.post('/api/upload_images', formData)
                    .then(response => {
                        ...
                        this.uploaded_images.push.apply(this.uploaded_images, response.data.data);
                        this.$emit('sortImage',{ images: this.uploaded_images});
                        this.images = [];
                        this.files = [];
                    }).finally(() => {
            ...
            deleteYoutubeFromServer(index) {
                this.loading_youtube = true;
                axios.get('/api/temp_youtube/delete/' + index)
                    .then(response => {
                        this.youtubes = [];
                        this.youtubes.push.apply(this.youtubes, response.data.data);
                        this.url_youtube = '';
